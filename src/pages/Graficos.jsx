    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-800 p-4 rounded-xl border border-slate-700 -mx-6 mt-8">
        ...
        <ResponsiveContainer width="100%" height={400}>
          <BarChart data={unitEquipmentArray} margin={{ top: 30, right: 30, left: 30, bottom: 80 }}>
            <CartesianGrid strokeDasharray="2 4" stroke="#475569" vertical={false} />
            <XAxis dataKey="name" angle={-45} textAnchor="end" height={200} stroke="#94a3b8" />
            <YAxis stroke="#94a3b8" hide={true} />
            <Tooltip content={<CustomTooltip />} />
            <Bar dataKey="kmPerLiter" fill={YELLOW} radius={[4, 4, 0, 0]}>
              <LabelList dataKey="kmPerLiter" position="insideBottomRight" formatter={(value) => typeof value === 'number' ? value.toFixed(2) : value} fill="#1f2937" fontSize={11} fontWeight="600" />
              <LabelList dataKey="kmPerLiter" position="bottom" formatter={() => 'Km/Lt'} fill="#1f2937" fontSize={9} offset={15} />
            </Bar>
          </BarChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-slate-800 p-8 rounded-xl border border-slate-700">
          ...
          <ResponsiveContainer width="100%" height={400}>
            <BarChart data={vehicleKmArray} layout="vertical" margin={{ top: 10, right: 30, left: 30, bottom: 10 }}>
